...
public class TourOpServiveImp implements TourOpService {
    ...
    @Override
    public ResponseEntity<?> registerTourOrg(TourOperator tourOperator) {

        Users user = getUser();
        List<Destination> destinations = new ArrayList<>();
        TourOperator tourOp1 = tourOPRRepository.findByTinNum(tourOperator.getTinNum());
        ...
        if (tourOp1 == null) {
            ...
            responseMessage = new ResponseMessage("success", "TourOperator Registered successfully");
            ...
            responseMessage = new ResponseMessage("success", "Tour operator info updated");
